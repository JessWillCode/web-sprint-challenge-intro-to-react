...
React JS is a library created by the team at Facebook to help the UI update and render faster regardless of the amount of traffic and activity on an application. It also allows us to create more responsive components instead of hard coding elements in the HTML.

1. Describe component state.

Component State is a set of properties used to control the behavior of the component. This is shown as a variable and a callback function that sets the variable value.

1. Describe props.

Props are argument properties of the React component. We pass them to components using JSX.
